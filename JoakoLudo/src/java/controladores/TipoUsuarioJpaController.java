    ...
    public void create(TipoUsuario tipoUsuario) throws RollbackFailureException, Exception {
        ...
        try {
            ...
            for (Usuario usuarioCollectionUsuario : tipoUsuario.getUsuarioCollection()) {
                TipoUsuario oldTipoUsuarioIdOfUsuarioCollectionUsuario = usuarioCollectionUsuario.getTipoUsuarioId();
                usuarioCollectionUsuario.setTipoUsuarioId(tipoUsuario);
                usuarioCollectionUsuario = em.merge(usuarioCollectionUsuario);
                if (oldTipoUsuarioIdOfUsuarioCollectionUsuario != null) {
                    oldTipoUsuarioIdOfUsuarioCollectionUsuario.getUsuarioCollection().remove(usuarioCollectionUsuario);
                    oldTipoUsuarioIdOfUsuarioCollectionUsuario = em.merge(oldTipoUsuarioIdOfUsuarioCollectionUsuario);
                }
            }
            utx.commit();
        } catch (Exception ex) {
        ...
        try {
            ...
            for (Usuario usuarioCollectionOldUsuario : usuarioCollectionOld) {
                if (!usuarioCollectionNew.contains(usuarioCollectionOldUsuario)) {
                    ...
                    illegalOrphanMessages.add("You must retain Usuario " + usuarioCollectionOldUsuario + " since its tipoUsuarioId field is not nullable.");
                }
            }
            if (illegalOrphanMessages != null) {
            ...
            for (Usuario usuarioCollectionNewUsuario : usuarioCollectionNew) {
                if (!usuarioCollectionOld.contains(usuarioCollectionNewUsuario)) {
                    TipoUsuario oldTipoUsuarioIdOfUsuarioCollectionNewUsuario = usuarioCollectionNewUsuario.getTipoUsuarioId();
                    usuarioCollectionNewUsuario.setTipoUsuarioId(tipoUsuario);
                    usuarioCollectionNewUsuario = em.merge(usuarioCollectionNewUsuario);
                    if (oldTipoUsuarioIdOfUsuarioCollectionNewUsuario != null && !oldTipoUsuarioIdOfUsuarioCollectionNewUsuario.equals(tipoUsuario)) {
                        oldTipoUsuarioIdOfUsuarioCollectionNewUsuario.getUsuarioCollection().remove(usuarioCollectionNewUsuario);
                        oldTipoUsuarioIdOfUsuarioCollectionNewUsuario = em.merge(oldTipoUsuarioIdOfUsuarioCollectionNewUsuario);
                    }
                }
            }
            utx.commit();
    ...
    public void destroy(Integer id) throws IllegalOrphanException, NonexistentEntityException, RollbackFailureException, Exception {
        ...
        try {
            ...
            for (Usuario usuarioCollectionOrphanCheckUsuario : usuarioCollectionOrphanCheck) {
                ...
                illegalOrphanMessages.add("This TipoUsuario (" + tipoUsuario + ") cannot be destroyed since the Usuario " + usuarioCollectionOrphanCheckUsuario + " in its usuarioCollection field has a non-nullable tipoUsuarioId field.");
            }
            if (illegalOrphanMessages != null) {
                throw new IllegalOrphanException(illegalOrphanMessages);
            }
