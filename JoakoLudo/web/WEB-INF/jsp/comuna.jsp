      ...
      <div class="row">
        <nav class="col-sm-6 col-md-3 hidden-xs-down bg-faded sidebar">
          ...
          <ul class="nav nav-pills flex-column">
            ...
            <li class="nav-item">
              <a class="nav-link" href="#">Intercambios hechos</a>
            </li>
          ...
          <ul class="nav nav-pills flex-column">
            <li class="nav-item">
              <a class="nav-link" href="#">Intercambios pendientes</a>
            </li>
        ...
        <main class="col-sm-9 offset-sm-3 col-md-9 offset-md-2 pt-3">
          <h1  class="cursive-font"><a >Administrador</a></h1>
          

          <h2>Nuevas Comunas</h2>
