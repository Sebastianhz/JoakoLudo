		...
		<div class="container">
			<div class="row" style="margin-top: 5em;">
				<div class="col-md-10 text-center">
					<h1 id="fh5co-logo" class="cursive-font"><a >Vivre-Book</a></h1>
				</div>    
			</div>
			<div class="row">
			...
			<div class="row row-pb-md">
				<div class="col-md-4">
					<div class="review text-center">
						...
						<blockquote>
							<p>&ldquo;Cagese de miedo.&rdquo;</p>
						</blockquote>
					</div>
				</div>
				<div class="col-md-4">
					<div class="review text-center">
						...
						<blockquote>
							<p>&ldquo;Vuela harry vuela!!.&rdquo;</p>
						</blockquote>
					</div>
				</div>
				<div class="col-md-4">
			...
			<div class="container">
				<div class="row text-center fh5co-heading">
					<div class="col-md-8 col-md-offset-2">
						<h2>Nueva comunnidad</h2>
						<p>Bienvenido todo aquel amante de los libros</p>
					</div>
				</div>
				<div class="row">
